...
sink("r2dis_84.7.1_noRD_bytw_wtmean1_diffstartval_diffst1weighmat_preweatherreg_metrodummies_moments_full_nldis_pr6.txt",split=T)
...
source("GetDataGooglePlaces_2dis_bytw_preweatherreg_moreinstr_withreallocthresh_stkoutthresh_five_averaged_pr6.R")
...
theta1 <- c(-1,0, -1,0,
            ...
            0.000000e+00,0.000000e+00,0.000000e+00,0.000000e+00,2.587059e+00,0.1,0.1)
