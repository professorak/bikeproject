...
sink("r2dis_84.7.1_noRD_noobswt_hyperlocal_majoritystates_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
source("GetDataGooglePlaces_2dis_aggmonth_hyperlocalstate_majoritystates_preweatherreg_moreinstr_withreallocthresh_stkoutthresh_five_averaged_pr6.R")

#setting obs_weight to 1
wdcMerged$obs_weight <- 1
wdcMerged$out_dem_sum <- wdcMerged$out_dem_mean
