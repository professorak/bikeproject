...
#   wdcMerged$googleplaces_movie_theater_den_1_2 <- wdcMerged$googleplaces_movie_theater_den_1 + wdcMerged$googleplaces_movie_theater_den_2
  metro_vars <- c("metro_den_on_a","metro_den_on_b","metro_den_on_c",
                  "metro_den_on_1","metro_den_on_2") #not including _3 and _4 as they are quite correlated with intercept.  
