...
lb = c(-100,-100,0,-1,-1,-1,-1,-1,rep(-30, length_delta), rep(-1.0e19,length_eta))
ub = c(100,100,0,1000000,1000000,1000000,1000000,1000000,rep(3, length_delta), rep(1.0e19,length_eta))
