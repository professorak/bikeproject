...
list_covariates <- eval_covariates_delta_reg(deltain_stin,theta1,wdcMerged_logmetro,points)
Z_logmetro <<- list_covariates$Z
list_covariates <- eval_covariates_delta_reg(deltain_stin,theta1,wdcMerged_logmetrocorrected,points)
Z_logmetrocorrected <<- list_covariates$Z
...
summary(lm(wdcMerged_logmetro$out_dem_mean ~ 
             Z_logmetro))
summary(lm(wdcMerged_logmetrocorrected$out_dem_mean ~ 
             Z_logmetrocorrected))
