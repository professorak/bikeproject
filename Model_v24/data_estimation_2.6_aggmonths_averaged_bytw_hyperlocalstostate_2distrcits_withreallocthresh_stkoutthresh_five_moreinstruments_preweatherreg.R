...
###save commands
# save(wdcMerged, file="wdcMerged_lin_dis1to2_aggmonths_bytw_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_dis1to2_aggmonths_bytw_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_dis1to2_aggmonths_bytw_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
# save(points, file="points_lin_dis1to2_aggmonths_bytw_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")

# save(wdcMerged, file="wdcMerged_lin_dis1to2_aggmonths_bytw_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr3.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_dis1to2_aggmonths_bytw_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr3.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_dis1to2_aggmonths_bytw_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr3.RData")
# save(points, file="points_lin_dis1to2_aggmonths_bytw_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr3.RData")
