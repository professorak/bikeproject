...
sink("r84.7.1_noRD_no0dem_bytw_wtmean1_diffst1weighmat_diffstartval1_strictcon_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
theta1 <- c(-10,0, -10,0,
            ...
            0.000000e+00,0.000000e+00,0.000000e+00,0.000000e+00,1,1,1)
