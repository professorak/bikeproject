...
sink("r84.7.1_noRD_logwts_hyperlocal_majoritystates_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
#setting obs_weight to log(obs_weight)
wdcMerged$obs_weight <- log(wdcMerged$obs_weight)
wdcMerged$obs_weight[which(wdcMerged$obs_weight==0)] <- 0.01
