...
vector<mat>  compute_prob(uint i, mat station_data, NumericMatrix xpoints, uint wdclat1_col, uint wdclon1_col,
    ...
    uvec st_point_list_uvec, rowvec deltain_row, urowvec mat_st_state_row, NumericVector xv0_vec, NumericVector xv0_vec_weights,
...
//          cart_product(prob_table, outputTemp2, prob_a.begin(), prob_a.end());          
          ...
          for(uint k=0; k <a_vec.size(); ++k) {
            ...
            for(uint l=0; l <a_vec_col.size(); ++l) {
              ...
              lambda_t(a_vec[k][l]) += compute_prob_vec_impl(i, station_data, xpoints, wdclat1_col, wdclon1_col, pointslat1_col, 
              pointslon1_col, beta1_vec, sigma0, xdeltain, st_point_list_uvec, deltain_row, mat_st_state_row,  
...
mat get_station_data_dis_step_mat(rowvec station_data_dis_org ) {
  ...
  mat station_data_dis_mat(2, station_data_dis_org.size());
  rowvec station_data_dis_sq = station_data_dis_org  % station_data_dis_org;
  station_data_dis_mat.row(0) = station_data_dis_org;
  station_data_dis_mat.row(1) = station_data_dis_sq;
...
double compute_prob_vec_impl(uint i, mat station_data, NumericMatrix xpoints, uint wdclat1_col, uint wdclon1_col,
    ...
    vec lambda_v0_vec = compute_probsum_v0_vec(i, station_data, xpoints, wdclat1_col, wdclon1_col,
      ...
      st_point_list_uvec,  deltain_row,  mat_st_state_row, 
