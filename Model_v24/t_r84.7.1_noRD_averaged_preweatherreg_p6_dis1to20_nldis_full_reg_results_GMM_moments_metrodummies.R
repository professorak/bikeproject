...
sink("r84.7.1_noRD_averaged_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
source("GetDataGooglePlaces_20dis_aggmonth_averaged_preweatherreg_moreinstr_withreallocthresh_stkoutthresh_five_averaged_pr6.R")
