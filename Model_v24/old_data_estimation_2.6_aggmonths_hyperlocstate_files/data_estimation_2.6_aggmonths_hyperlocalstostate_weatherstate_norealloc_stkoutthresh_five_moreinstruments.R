...
###save commands
# save(wdcMerged, file="wdcMerged_lin_dis1to10_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr6.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_dis1to10_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr6.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_dis1to10_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr6.RData")
# save(points, file="points_lin_dis1to10_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr6.RData")

# save(wdcMerged, file="wdcMerged_lin_dis1to10_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr3.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_dis1to10_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr3.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_dis1to10_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr3.RData")
# save(points, file="points_lin_dis1to10_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr3.RData")
