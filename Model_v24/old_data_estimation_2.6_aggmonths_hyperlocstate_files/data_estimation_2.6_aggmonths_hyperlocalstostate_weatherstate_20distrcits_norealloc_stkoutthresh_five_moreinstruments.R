...
source("data_prep_functions_ffdf_limstostate_hyperlocalstostate_norealloc.R")
...
for( i in 1:length(filelist_all_mons)) {
  ...
  save_file <- paste0(csv_dir,"/ffdb/wdcMerged_bootstrap_hyperlocalstostate_norealloc_stkoutthresh_den",
...
###save commands
# save(wdcMerged, file="wdcMerged_lin_dis1to20_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr6.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_dis1to20_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr6.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_dis1to20_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr6.RData")
# save(points, file="points_lin_dis1to20_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr6.RData")

# save(wdcMerged, file="wdcMerged_lin_dis1to20_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr3.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_dis1to20_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr3.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_dis1to20_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr3.RData")
# save(points, file="points_lin_dis1to20_aggmonths_hyperlocalstate_weatherstate_norealloc_stkoutthresh_five_pr3.RData")
