...
source("data_estimation_2.6_weather_20dis_tw1hr_aggmonth_hyperlocalstate_preweatherreg_moreinstr_withreallocthresh_stkoutthresh_five_averaged_pr6_saved.R")
...
wdcMerged <<- removemodify_outlier_states_keep_majoritystates_no0dem(wdcMerged)
