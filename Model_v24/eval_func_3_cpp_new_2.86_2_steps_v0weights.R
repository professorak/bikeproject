...
eval_grad_lambda_theta_new <- function(theta1, deltain_tw, wdcMergedday, points, 
  ...
  grad_t <- eval_grad_lambda_theta_cpp_new(deltain_tw,theta1,wdcMergedday,points_mat,no_st,max_walking_dis,v0_vec, v0_vec_weights,
  ...
  grad_t_densitycols <- eval_lambda_multiple_cpp_new(deltain_tw,theta1,wdcMergedday,points_mat,no_st,max_walking_dis,v0_vec, v0_vec_weights,
      as.character(sto_state_local), as.character(local_stations), as.character(points_local_stations), nonden_ceoflength)  
...
eval_grad_lambda_new <- function(theta1, deltain_tw, wdcMergedday, points, 
  ...
  points_mat = as.matrix(points_mat)
  grad_t_all <- eval_grad_lambda_cpp_new(deltain_tw,theta1,wdcMergedday,points_mat,no_st,max_walking_dis,v0_vec, v0_vec_weights,
      as.character(sto_state_local), as.character(local_stations), as.character(points_local_stations),nonden_ceoflength)  
  return(grad_t_all)  
}  
...
eval_hessian_delta_sq_tw <- function(deltain_tw, theta1, wdcMergedday, points, tw_groupin,lambda_multiplers_in) {
  ...
  hessian_lambda_delta_sq <- eval_hessian_lambda_delta_sq_cpp(deltain_tw,theta1,wdcMergedday,points_mat,no_st,max_walking_dis,v0_vec, v0_vec_weights,
                                                              as.character(sto_state_local), as.character(local_stations), as.character(points_local_stations),
...
eval_hessian_beta1_sq_tw <- function(deltain_tw, theta1, wdcMergedday, points, tw_groupin,lambda_multiplers_in) {
  ...
  hessian_lambda_beta1_sq <- eval_hessian_lambda_beta1_sq_cpp(deltain_tw,theta1,wdcMergedday,points_mat,no_st,max_walking_dis,v0_vec, v0_vec_weights,
                                                              as.character(sto_state_local), as.character(local_stations), as.character(points_local_stations),
                                                              lambda_multiplers_in, nonden_ceoflength)
...
eval_hessian_theta1_sq_tw <- function(deltain_tw, theta1, wdcMergedday, points, tw_groupin,lambda_multiplers_in) {
  ...
  hessian_lambda_theta1_sq <- eval_hessian_lambda_theta1_sq_cpp(deltain_tw,theta1,wdcMergedday,points_mat,no_st,max_walking_dis,v0_vec, v0_vec_weights,
                                                              as.character(sto_state_local), as.character(local_stations), as.character(points_local_stations),
                                                              lambda_multiplers_in, nonden_ceoflength)
...
eval_hessian_lambda_theta1_delta_tw <- function(deltain_tw, theta1, wdcMergedday, points, tw_groupin,lambda_multiplers_in) {
  ...
  hessian_lambda_theta1_delta <- eval_hessian_lambda_theta1_delta_cpp(deltain_tw,theta1,wdcMergedday,points_mat,no_st,max_walking_dis,v0_vec, v0_vec_weights,
                                                                as.character(sto_state_local), as.character(local_stations), as.character(points_local_stations),
                                                                lambda_multiplers_in, nonden_ceoflength)
...
eval_hessian_lambda_constraints_MPEC_tw_groupin <- function(deltain_tw, theta1, wdcMergedday, points, tw_groupin, lambda_multiplers_tw) {
  ...
  hessian_lambda_all <- eval_hessian_lambda_cpp(deltain_tw,theta1,wdcMergedday,points_mat,no_st,max_walking_dis,v0_vec, v0_vec_weights,
                                                as.character(sto_state_local), as.character(local_stations), as.character(points_local_stations),
...
eval_hessian_lambda_constraints_MPEC <- function(deltain_stin, theta1, eta, wdcMerged, points, lambda_multiplers_in) {  
  ...
  hessian_lambda_theta1_sq <- matrix(0,length(theta1),length(theta1))
