...
filelist_all <- c("Paris/ind_paris_5.csv")
filelist_all_mons <- c(5)
filelist_all_weather <- c("weatherdata_2013-5.csv")
...
system.time({
  wdcMerged <- merge(wdcMerged,as.ffdf(weather_data), by=c("day","time_halfhour_int"))    
})
...
nrow_wdcMerged <- nrow(wdcMerged)
system.time({
  wdcMerged <- merge(wdcMerged,as.ffdf(weather_scale_df), by=c("day","time_halfhour_int"))    
})
...
###save commands
# save(wdcMerged, file="wdcMerged_lin_dis1to20_aggmonths_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_dis1to20_aggmonths_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_dis1to20_aggmonths_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
# save(points, file="points_lin_dis1to20_aggmonths_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")

# save(wdcMerged, file="wdcMerged_lin_dis1to20_aggmonths_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr3.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_dis1to20_aggmonths_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr3.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_dis1to20_aggmonths_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr3.RData")
# save(points, file="points_lin_dis1to20_aggmonths_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr3.RData")
