...
load(file="wdcMerged_lin_dis1to20_aggmonths_bytw_1hr_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
load(file="current_serv_lvl_lin_dis1to20_aggmonths_bytw_1hr_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
load(file="user_serv_lvl_lin_dis1to20_aggmonths_bytw_1hr_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
load(file="points_lin_dis1to20_aggmonths_bytw_1hr_hyperlocalstate_withreallocthresh_preweatherreg_stkoutthresh_five_pr6.RData")
v0_vec <- c(0)
