...
sink("r84.7.1_noRD_no0dem_bytw_wtmean1_diffst1weighmat_diffstartval3_strictcon_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
theta1 <- c(1,0, -20,0,
            2.101448e-01,1,2.101448e-01,0.000000e+00,0.000000e+00,
