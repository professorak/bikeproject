...
point_range <- 3
no_bootstrap_runs <- 1
reg_runs_save_file <- "reg_runs_discoef_2.89_8states_nldis_mw6_bootstrap.txt"


source("eval_func_4_GMM_new_temp_2.89_nldis.R")
...
sourceCpp(file="eval_func_2_new_deltaaveraged_nldis.cpp")
...
#   filelist_all_mons <- c(7)
  ...
  for( i in 1:length(filelist_all_mons)) {
    ...
    save_file <- paste0(csv_dir,"/ffdb/wdcMerged_bootstrap_limstostate_5_8",
