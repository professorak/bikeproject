...
lb = c(-100,0,-1,-1,-1,-1,-1,rep(-30, length_stklist))
ub = c(0,0,1000000,1000000,1000000,1000000,1000000,rep(0, length_stklist))
constraint_lb <- c(rep(0, length_stklist), target_density_constraint) 
constraint_ub <- c(rep(0, length_stklist), target_density_constraint)
