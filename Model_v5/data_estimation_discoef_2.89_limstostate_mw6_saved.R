...
load(file="wdcMerged_lin.RData")
load(file="current_serv_lvl_lin.RData")
load(file="user_serv_lvl_lin.RData")
load(file="points_lin.RData")
v0_vec <- c(0)
...
#save commands
# save(wdcMerged, file="wdcMerged_lin.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin.RData")
# save(points, file="points_lin.RData")
