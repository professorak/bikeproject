...
#     }
    ...
    current_serv_lvl$st_tw <- as.factor(paste0(current_serv_lvl$station_id_index,"_",current_serv_lvl$tw_group))
    ...
    current_serv_lvl$tract_tw <- as.factor(paste0(current_serv_lvl$tract,"_",current_serv_lvl$tw_group))
