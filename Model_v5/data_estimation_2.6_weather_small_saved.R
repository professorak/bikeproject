...
load(file="wdcMerged_lin_weather_small.RData")
load(file="current_serv_lvl_lin_weather_small.RData")
load(file="user_serv_lvl_lin_weather_small.RData")
load(file="points_lin_weather_small.RData")
v0_vec <- c(0)
...
#save commands
# save(wdcMerged, file="wdcMerged_lin_weather_small.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_weather_small.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_weather_small.RData")
# save(points, file="points_lin_weather_small.RData")
