...
load(file="wdcMerged_lin_weather.RData")
load(file="current_serv_lvl_lin_weather.RData")
load(file="user_serv_lvl_lin_weather.RData")
load(file="points_lin_weather.RData")
v0_vec <- c(0)
