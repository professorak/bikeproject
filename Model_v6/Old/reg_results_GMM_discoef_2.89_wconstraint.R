...
constraint_lb <- c(100000)
constraint_ub <- c(100000)
...
res <- ipoptr( x0=x0,
               ...
               eval_g=get_total_density,
               eval_jac_g=get_grad_total_density,
...
theta2 <- eval_error_xi(c(theta1[1],0,theta1[-1]),wdcMerged,points)$theta2
