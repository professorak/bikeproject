...
#   wdcMerged$googleplaces_movie_theater_den_1_2 <- wdcMerged$googleplaces_movie_theater_den_1 + wdcMerged$googleplaces_movie_theater_den_2
  wdcMerged$diff_dem_rate_lagtw_sq <- wdcMerged$diff_dem_rate_lagtw * abs(wdcMerged$diff_dem_rate_lagtw) #taking abs to preserve sign
  ...
  list_covariates <- c("metro_den_on_a","metro_den_on_b","metro_den_on_c","metro_den_on_1","metro_den_on_2","metro_den_on_3","metro_den_on_4",
                     ...
                     "diff_dem_rate_lagtw","diff_dem_rate_lagtw_sq")
