...
sink("deriv_test_hyperlocal_nldis_r70.5_step2_2dis.txt",split=T)

#least squares implementation 

get_points_density_grad_places_count_col <- NULL
source("eval_obj_GMM_model5.R")
source("GetDataGooglePlaces_2dis_aggmonth_hyperlocalstate_norealloc_stkoutthresh_five_averaged_pr6.R")
