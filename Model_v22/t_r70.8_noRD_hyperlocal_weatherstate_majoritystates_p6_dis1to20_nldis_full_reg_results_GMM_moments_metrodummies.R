...
sink("r70.8_noRD_hyperlocal_weatherstate_majoritystates_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)

#least squares implementation 

get_points_density_grad_places_count_col <- NULL
source("eval_obj_GMM_model5.R")
source("GetDataGooglePlaces_20dis_aggmonth_hyperlocalstate_weatherstate_majoritystates_moreinstr_norealloc_stkoutthresh_five_averaged_pr6.R")
v0_vec <- c(0)
...
source("eval_covariates_delta_reg_densitycols_setb40.8_weatherstate_wmetrooff_metrodummies.R") 
