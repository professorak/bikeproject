...
theta1 <- c(-2.20961045069201, 0.275211519, -19.6523343222199, 0.00523699070208834, 2.12663960984702, 
...
write.csv(results_counterfactual_l2,"results_counterfactual_l2_2.txt")
...
write.csv(perc_demand_substituted, "perc_demand_substituted.csv")
...
write.csv(results_distance_segment_demand[[2]], "results_distance_segment_demand.csv")
