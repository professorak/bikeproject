...
sink("r81.7.1_noRD_hyperlocal_majoritystates_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb49.6_wservlvl_metrooff_metrodummies.R")  
...
active_coef_nointercept <- c(1:length(theta1))[-c(2,density_intercept_col,
                                                  density_google_places_theta_cols,density_ridership_col,density_add_den_cols[1])]
...
ub = c(c(50,0,50),
       0,rep(1000000,2),1000000,rep(0,5),0,1000000,1000000,1000000,
