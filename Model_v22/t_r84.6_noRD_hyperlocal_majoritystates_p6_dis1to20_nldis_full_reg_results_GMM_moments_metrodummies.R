...
sink("r84.6_noRD_hyperlocal_majoritystates_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)

#least squares implementation 
#using difference of incoming and outgoing demand from previous tw as instrument
...
source("eval_covariates_delta_reg_densitycols_setb52.6_wservlvl_metrooff_metrodummies.R")  
