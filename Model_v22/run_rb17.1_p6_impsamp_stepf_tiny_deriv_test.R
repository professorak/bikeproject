...
sink("deriv_test_tiny_impsampl_rb17.1_1:10_full_stepf_pr6.txt",split=T)
...
sourceCpp("eval_func_2_new_deltaaveraged_stepfunction_v0weights_set1.cpp") 
...
theta1 <- c(-15.0363528438044, 1, -11.69613153711,
            c(0, 3.56400131121065, 0.0151809839374334, 0, 0.00822638613922138, 0.000751098339022488,
              9.47693298685854e-10, 0.00477686078154983, 8.46891338865097e-08, 0, 0.981490763648657))
...
tot_density <<- 1000
target_density_constraint <<- 1000
