...
source("data_prep_functions_ffdf_limstostate_norealloc.R")
...
for( i in 1:length(filelist_all_mons)) {
  ...
  save_file <- paste0(csv_dir,"/ffdb/wdcMerged_bootstrap_limstostate_5_8_norealloc_stkoutthresh_den",
...
weather_data <- get_weather_data_junk(filelist_all_weather)
...
#changing two lines below so that it is aggregated irrespective of 
#sto state. 
...
#now aggregate and keep only 1 tw
wdcMerged$out_dem_sum <- wdcMerged$out_dem_sum/wdcMerged$obs_weight
wdcMerged$obs_weight <- 1
  #average by station
wdcMerged$out_dem_sum <- ave(wdcMerged$out_dem_sum,by=wdcMerged$station_id_index,FUN=mean)
wdcMerged <- subset(wdcMerged,tw==1)
wdcMerged <- droplevels(wdcMerged)
...
###save commands
# save(wdcMerged, file="wdcMerged_lin_weather_dis1to20_aggmonths_norealloc_stkoutthresh_five_averaged_pr6.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_weather_dis1to20_aggmonths_norealloc_stkoutthresh_five_averaged_pr6.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_weather_dis1to20_aggmonths_norealloc_stkoutthresh_five_averaged_pr6.RData")
# save(points, file="points_lin_weather_dis1to20_aggmonths_norealloc_stkoutthresh_five_averaged_pr6.RData")


# save(wdcMerged, file="wdcMerged_lin_weather_dis1to20_aggmonths_norealloc_stkoutthresh_five_averaged_pr3.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_weather_dis1to20_aggmonths_norealloc_stkoutthresh_five_averaged_pr3.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_weather_dis1to20_aggmonths_norealloc_stkoutthresh_five_averaged_pr3.RData")
# save(points, file="points_lin_weather_dis1to20_aggmonths_norealloc_stkoutthresh_five_averaged_pr3.RData")
