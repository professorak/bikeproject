...
sink("r82.7.1_noRD_logtourist_hyperlocal_majoritystates_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
#log of tourist locations traffic
points_tourist_idx <- which(points$type==4)
points$weight[points_tourist_idx] <- log(points$weight[points_tourist_idx]*13650000)
...
list_update_vars <- c("metro_den_on_1","metro_den_on_2","metro_den_off_1","metro_den_off_2",
                     ...
                     "metro_den_off_a","metro_den_off_b","metro_den_off_c","touristlocs_den_1",
                     "touristlocs_den_2","touristlocs_den_3","touristlocs_den_4",
...
#bring lowest to 0 so that coefficient on this is positive.
points$weight[points_tourist_idx] <- points$weight[points_tourist_idx] - min(points$weight[points_tourist_idx])
print_iter_values <<- 1
