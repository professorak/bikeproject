...
for( i in 1:length(filelist_all_mons)) {
  ...
  save_file <- paste0(csv_dir,"/ffdb/wdcMerged_bootstrap_limstostate_5_8_norealloc_den",
...
#havent crawled googleplaces data yet, 
#creating 0 data 
places_data_cols <- c("places_count","cafe", "grocery_or_supermarket","local_government_office","food")
places_data_temp_full <- 
  as.data.frame(matrix(0,nrow=nrow(points),ncol=length(places_data_cols)))
colnames(places_data_temp_full) <- places_data_cols
...
###save commands
# save(wdcMerged, file="wdcMerged_lin_weather_dis1to20_aggmonths_bytw_norealloc_averaged_pr6.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_weather_dis1to20_aggmonths_bytw_norealloc_averaged_pr6.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_weather_dis1to20_aggmonths_bytw_norealloc_averaged_pr6.RData")
# save(points, file="points_lin_weather_dis1to20_aggmonths_bytw_norealloc_averaged_pr6.RData")
