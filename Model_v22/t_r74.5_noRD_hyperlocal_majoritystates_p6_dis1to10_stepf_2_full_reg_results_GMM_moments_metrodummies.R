...
sink("r74.5_noRD_hyperlocal_majoritystates_metrodummies_moments_1:10_full_stepf_2_pr6.txt",split=T)

#least squares implementation 

get_points_density_grad_places_count_col <- NULL
source("eval_obj_GMM_model5.R")
source("GetDataGooglePlaces_10dis_aggmonth_hyperlocalstate_majoritystates_norealloc_stkoutthresh_five_averaged_pr6.R")
v0_vec <- c(0)
