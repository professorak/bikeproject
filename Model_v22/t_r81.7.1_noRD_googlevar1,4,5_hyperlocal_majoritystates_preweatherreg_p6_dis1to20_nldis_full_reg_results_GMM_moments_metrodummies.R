...
sink("r81.7.1_noRD_googlevar1,4,5_hyperlocal_majoritystates_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
active_coef <- c(1:length(theta1))[-c(2,density_google_places_theta_cols[-c(1,4,5)],
                                      density_ridership_col,density_add_den_cols[1])]
