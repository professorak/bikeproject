...
sink("r82.71_noRD_hyperlocal_majoritystates_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
source("GetDataGooglePlaces_20dis_aggmonth_hyperlocalstate_majoritystates_moreinstr_withreallocthresh_stkoutthresh_five_averaged_pr6.R")
v0_vec <- c(0)
...
source("eval_covariates_delta_reg_densitycols_setb50.71_wservlvl_metrooff_metrodummies.R")  
...
theta1 <- c(-2.309775e+00,0, -2.500129e+01,0,
            2.101448e-01,2.411672e-01,2.101448e-01,c(0.1,0,0.1,0.1,0.1),0.000000e+00,
            4.587059e+00,0.1,0.1)
...
ub = c(c(50,0,50),
       1000000,rep(1000000,2),1000000,c(1000000,0,1000000,1000000,1000000),0,1000000,1000000,1000000,
