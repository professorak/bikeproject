...
load(file="wdcMerged_lin_weather_dis1to20_aggmonths_bytw_norealloc_stkoutthresh_five_averaged_pr6.RData")
load(file="current_serv_lvl_lin_weather_dis1to20_aggmonths_bytw_norealloc_stkoutthresh_five_averaged_pr6.RData")
load(file="user_serv_lvl_lin_weather_dis1to20_aggmonths_bytw_norealloc_stkoutthresh_five_averaged_pr6.RData")
load(file="points_lin_weather_dis1to20_aggmonths_bytw_norealloc_stkoutthresh_five_averaged_pr6.RData")
v0_vec <- c(0)
