...
sink("r84.5_noRD_hyperlocal_majoritystates_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb52_wservlvl_metrooff_metrodummies.R")  
