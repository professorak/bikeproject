...
sink("r74.5_withRD_hyperlocal_majoritystates_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)

#least squares implementation 

get_points_density_grad_places_count_col <- NULL
source("eval_obj_GMM_model5.R")
source("GetDataGooglePlaces_20dis_aggmonth_hyperlocalstate_majoritystates_norealloc_stkoutthresh_five_averaged_pr6.R")
...
source("eval_covariates_delta_reg_densitycols_setb42_wservlvl_metrooff_metrodummies.R") 
...
theta1 <- c(-2.309775e+00,1, -2.500129e+01,0,
...
active_coef <- c(1:length(theta1))[-c(density_google_places_theta_cols,
