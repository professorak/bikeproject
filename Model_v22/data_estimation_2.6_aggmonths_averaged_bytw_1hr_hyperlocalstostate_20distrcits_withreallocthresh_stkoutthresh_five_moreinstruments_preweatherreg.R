...
#note that time_halfhour_int converts based on GMT times which is n_time_int. 
#but since weather data is doing the same, it is fine

wdcMerged$tw_halfhour <- wdcMerged$time_halfhour_int %% 48
...
wdcMerged <- get_local_attributes_st_state_alt_tw(wdcMerged, points,c(0:5)) #assining 00-06 as metro off hours 
#(although in reality it is 0030-0530, need to correct using 1/2 hrs.)
