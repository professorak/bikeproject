...
sink("r82.7.1_noRD_hyperlocal_majoritystates_preweatherreg_metrodummies_moments_1:20_full_nldis_pr12.txt",split=T)
...
source("GetDataGooglePlaces_20dis_aggmonth_hyperlocalstate_majoritystates_preweatherreg_moreinstr_withreallocthresh_stkoutthresh_five_averaged_pr12.R")
