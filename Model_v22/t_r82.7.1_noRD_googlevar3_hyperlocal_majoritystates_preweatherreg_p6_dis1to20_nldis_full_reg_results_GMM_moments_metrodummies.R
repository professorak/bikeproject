...
sink("r82.7.1_noRD_googlevar3_hyperlocal_majoritystates_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
#_googlevar3=lodging
...
source("eval_covariates_delta_reg_densitycols_setb50.6_googlevar3_wservlvl_metrooff_metrodummies.R")  
...
theta1 <- c(-1.007475e+01, 0.000000e+00, -4.227785e+01, 2.066241e-03, 
  4.765002e-01, 1.997005e-01, 7.079696e-01, 
  0.000000e+00, 0.000000e+00, 1.428133e-01, 0.000000e+00, 0.000000e+00, 
  0.000000e+00, 6.513429e+00, 0, 0)

active_coef <- c(1:length(theta1))[-c(2,density_google_places_theta_cols[-3],
                                      density_add_den_cols[1])]
active_coef_nointercept <- c(1:length(theta1))[-c(2,density_intercept_col,
                                                  density_google_places_theta_cols[-3],density_add_den_cols[1])]
...
ub = c(c(50,0,50),
       1000000,rep(1000000,2),1000000,c(0,0,1000000,0,0),0,1000000,1000000,1000000,
