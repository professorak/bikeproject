...
sink("rb70.1_nonave_1:10_full_nldis_pr3.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb36_wmetro_off.R") 
...
ub = c(c(300,10,300),
       1000000,rep(1000000,2),1000000,rep(0,5),0,1000000,
