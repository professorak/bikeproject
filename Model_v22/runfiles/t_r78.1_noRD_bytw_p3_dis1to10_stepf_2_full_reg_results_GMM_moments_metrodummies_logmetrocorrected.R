...
sink("r78.1_noRD_bytw_metrodummies_logmetrocorrected_moments_1:10_full_stepf_2_pr3.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb46_wservlvl_metrooff_metrodummies.R")
