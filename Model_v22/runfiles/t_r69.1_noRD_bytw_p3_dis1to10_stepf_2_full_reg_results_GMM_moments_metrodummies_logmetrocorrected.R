...
sink("r69.1_noRD_bytw_metrodummies_logmetrocorrected_moments_1:10_full_stepf_2_pr3.txt",split=T)

#least squares implementation 

get_points_density_grad_places_count_col <- NULL
source("eval_obj_GMM_model5.R")
source("GetDataGooglePlaces_10dis_aggmonth_bytw_norealloc_stkoutthresh_five_averaged_pr3.R")
v0_vec <- c(0)
...
source("eval_covariates_delta_reg_densitycols_setb39_wmetrooff_metrodummies.R")
...
active_coef <- c(1:length(theta1))[-c(2,density_google_places_theta_cols,density_ridership_col,
