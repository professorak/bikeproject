...
theta1 <- c(-8.74463799748461, 0.000673370992741172, -10.4642375185142,
c(0.0237420645138136, 29.159036291003, 0.0875909491513248, 0, 0.157109637649333, 
0.00787556703389361, 0, 0.101376527013782, 0.00686969702367455, 0.0569824905006287, 
30.6110861321206))

get_total_density(theta1, wdcMerged, points )
sum(wdcMerged$out_dem_mean)/get_total_density(theta1, wdcMerged, points )*100

active_coef <- c(1:length(theta1))[-c(density_metro_evening_col)]
...
# theta1_case2 <- c(-2.53075905,1.32764102,-15.53126188,
# 0.02719937,10.84825125,0.07117308,0.00000000,0.17423426,0.01024403,
# 0.00233275,0.11874288,0.05415367,0.22199019,18.45104513)
