...
sink("rb59.1_ls_1:20_full_nldis_pr6.txt",split=T)
...
theta1 <- c(-15.0363528438044, 4, -11.69613153711,
            c(0, 3.56400131121065, 0.0151809839374334, 0, rep(0.1,5), 0, 0.981490763648657)*10)

active_coef <- c(1:length(theta1))[-c(density_metro_evening_col,density_ridership_col,
...
ub = c(c(300,100,300),
       0,rep(1000000,2),0,rep(1.0e19,5),0,1000000,
       rep(100, length_delta), rep(1.0e19,length_eta))
