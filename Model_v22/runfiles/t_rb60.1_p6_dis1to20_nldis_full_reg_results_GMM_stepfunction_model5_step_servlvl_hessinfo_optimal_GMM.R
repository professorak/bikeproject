...
sink("rb60.1_ls_1:20_full_nldis_pr6.txt",split=T)
...
theta1 <- c(-15.0363528438044, 0, -11.69613153711,
            c(1, 3.56400131121065, 0.0151809839374334, 0, rep(0.1,5), 0, 0.981490763648657)*10)
...
ub = c(c(300,100,300),
       1000000,rep(1000000,2),0,rep(1.0e19,5),0,1000000,
       rep(100, length_delta), rep(1.0e19,length_eta))
