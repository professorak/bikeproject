...
sink("rb69.1_nonave_1:10_full_nldis_pr3.txt",split=T)

#least squares implementation 

get_points_density_grad_places_count_col <- NULL
source("eval_obj_GMM_model5.R")
source("GetDataGooglePlaces_aggmonths_norealloc_stkoutthresh_five_pr3.R")
...
theta1 <- c(-2.309775e+00,1.839464e-03, -2.500129e+01,0,
            ...
            0.000000e+00,0.000000e+00,0.000000e+00,0.000000e+00,4.587059e+00)

active_coef <- c(1:length(theta1))[-c(density_ridership_col,density_google_places_theta_cols,
                                      density_add_den_cols[1])]
active_coef_nointercept <- c(1:length(theta1))[-c(density_intercept_col,
...
ub = c(c(300,10,300),
       0,rep(1000000,2),1000000,rep(0,5),0,1000000,
