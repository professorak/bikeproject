...
sink("rb70.3_metrodummies_logmetrocorrected_moments_1:10_stepf_2_pr3.txt",split=T)

#least squares implementation 

get_points_density_grad_places_count_col <- NULL
source("eval_obj_GMM_model5.R")
source("GetDataGooglePlaces_aggmonths_averaged_norealloc_stkoutthresh_five_pr3.R")
...
sourceCpp("eval_func_2_new_deltaaveraged_stepfunction_2_v0weights_set2.cpp") 
...
source("eval_covariates_delta_reg_densitycols_setb38_wmetrodummies.R") 
...
theta1 <- c(-2.309775e+00,0, -2.500129e+01,0,
            2.101448e-01,2.411672e-01,0.000000e+00,0.000000e+00,0.000000e+00,
            0.000000e+00,0.000000e+00,0.000000e+00,0.000000e+00,4.587059e+00,0.1,0)

active_coef <- c(1:length(theta1))[-c(2,density_metro_evening_col,density_google_places_theta_cols,
                                      density_add_den_cols[c(1,4)])]
active_coef_nointercept <- c(1:length(theta1))[-c(2,density_intercept_col,density_metro_evening_col,
                                                  density_google_places_theta_cols,density_add_den_cols[c(1,4)])]
...
ub = c(c(300,0,300),
       1000000,rep(1000000,2),0,rep(0,5),0,1000000,1000000,0,
       rep(100, length_delta), rep(1.0e19,length_eta))
