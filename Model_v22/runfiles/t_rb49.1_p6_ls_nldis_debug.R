...
#metro weights in percentile
points_metro_idx <- which(points$type==2)
points$weight[points_metro_idx] <- order(order(points$weight[points_metro_idx]))/length(points_metro_idx)
...
theta1 <- c(-6.52200865874744, 0.000429306424882155, -14.3775846793069,
  0, 5.2976094857142, 0.246745090467367, 0, 0, 0, 0, 0, 0, 0, 3.90723124226749)
...
theta1_case2 <- c(-2, 0.000429306424882155, -14.3775846793069,
                    0, 5.2976094857142, 0.246745090467367, 0, 0, 0, 0, 0, 0, 0, 3.90723124226749)
