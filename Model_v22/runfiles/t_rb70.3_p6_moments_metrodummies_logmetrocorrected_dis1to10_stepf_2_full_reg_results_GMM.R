...
sink("rb70.3_metrodummies_logmetrocorrected_moments_1:10_stepf_2_pr6.txt",split=T)

#least squares implementation 

get_points_density_grad_places_count_col <- NULL
source("eval_obj_GMM_model5.R")
source("GetDataGooglePlaces_aggmonths_averaged_norealloc_stkoutthresh_five.R")
