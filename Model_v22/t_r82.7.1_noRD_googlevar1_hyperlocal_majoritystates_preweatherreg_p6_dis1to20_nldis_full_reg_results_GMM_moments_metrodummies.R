...
sink("r82.7.1_noRD_googlevar1_hyperlocal_majoritystates_preweatherreg_metrodummies_moments_1:20_full_nldis_pr6.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb50.6_googlevar1_wservlvl_metrooff_metrodummies.R")  
...
theta1 <- c(-2.309775e+00,0, -2.500129e+01,0,
            2.101448e-01,2.411672e-01,2.101448e-01,0.1,0.000000e+00,
            0.000000e+00,0.000000e+00,0.000000e+00,0.000000e+00,4.587059e+00,0.1,0.1)

active_coef <- c(1:length(theta1))[-c(2,density_google_places_theta_cols[-1],
                                      density_add_den_cols[1])]
active_coef_nointercept <- c(1:length(theta1))[-c(2,density_intercept_col,
                                                  density_google_places_theta_cols[-1],density_add_den_cols[1])]
...
ub = c(c(50,0,50),
       1000000,rep(1000000,2),1000000,c(1000000,0,0,0,0),0,1000000,1000000,1000000,
