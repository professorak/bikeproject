    ...
    for(uint i=10191;i<10192;i++) {
        ...
        for(uint k=0; k< obs_no_vec.size(); ++k) {
          ...
          for(uint l=0; l <obs_no_vec_col.size(); ++l) {
            ...
            cout << "obs no: " << obs_no_vec_col[l] << endl;
            cout << "station_point_stkt_state " << endl; station_point_stkt_state.print();
            vector<size_t> idx =  ordered(station_local_stations);
