...
sink("r74.5_noRD_hyperlocal_majoritystates_metrodummies_moments_1:10_full_stepf_pr6.txt",split=T)
...
sourceCpp("eval_func_2_hyperlocal_stepfunction_v0weights_set2.cpp")  
