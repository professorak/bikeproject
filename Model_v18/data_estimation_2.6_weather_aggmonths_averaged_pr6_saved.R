...
load(file="wdcMerged_lin_weather_aggmonths_averaged_pr6.RData")
load(file="current_serv_lvl_lin_weather_aggmonths_averaged_pr6.RData")
load(file="user_serv_lvl_lin_weather_aggmonths_averaged_pr6.RData")
load(file="points_lin_weather_aggmonths_averaged_pr6.RData")
v0_vec <- c(0)
