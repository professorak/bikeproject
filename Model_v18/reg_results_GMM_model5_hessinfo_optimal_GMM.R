...
ub = c(100,0,1000000,1000000,1000000,1000000,1000000,rep(10, length_delta), rep(1.0e19,length_eta))
...
theta_save
res_save$objective
theta2_save[which(rownames(theta2_save)=="serv_lvl")]/0.0006466922293
...
theta
res$objective
theta2[which(rownames(theta2)=="serv_lvl")]/0.0006466922293
round(theta[active_coef_nointercept]/sqrt(diag(var_covar_theta)),2)
