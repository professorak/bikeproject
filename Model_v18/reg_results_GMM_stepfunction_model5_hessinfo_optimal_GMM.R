...
ub = c(100,100,0,1000000,1000000,1000000,1000000,1000000,rep(10, length_delta), rep(1.0e19,length_eta))
...
theta_save
res_save$objective
theta2_save[which(rownames(theta2_save)=="serv_lvl")]
...
theta
res$objective
theta2[which(rownames(theta2_save)=="serv_lvl")]
round(theta[active_coef_nointercept]/sqrt(diag(var_covar_theta)),2)
