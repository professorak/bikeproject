...
colnames_theta1 <<- c("dis coef","rand coef","stepfunction_coef","density ridership","density metro","density intercept",
...
theta <- c(-4 ,1, 1, 146.83, 20, 203.69, 0.42, 9.41)
...
lb = c(-100,-100,0,rep(0,5),rep(-20, length_delta), rep(-1.0e19,length_eta))
ub = c(100,100,1000000,1000000,1000000,1000000,1000000,1000000,rep(10, length_delta), rep(1.0e19,length_eta))
