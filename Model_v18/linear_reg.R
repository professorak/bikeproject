...
list_density_vars <- paste0("metro_den_on_1 + metro_den_on_2 + metro_den_off_1 + metro_den_off_2 + bus_den_1 + bus_den_2 + googleplaces_den_1 + googleplaces_den_2",
...
reg_formula <- as.formula(paste0("log(out_dem_mean+1) ~ ",list_density_vars, "+ serv_lvl | ", list_density_vars,
                        "+ instr_serv_lvl + serv_lvl_neighbours"))

reg_formula_tractfe <- as.formula(paste0("log(out_dem_mean+1) ~ ",list_density_vars, "+ serv_lvl + tract_tw_fac | ", list_density_vars,
