#..set5 + single step for service level
...
eval_covariates_delta_reg <- function(deltain,theta1,wdcMerged,points) {
  ...
  Zbase <- cbind(Zbase, instr_serv_lvl=wdcMerged$instr_serv_lvl[stocked_list], 
                 serv_lvl_neighbours=wdcMerged$serv_lvl_neighbours[stocked_list])
