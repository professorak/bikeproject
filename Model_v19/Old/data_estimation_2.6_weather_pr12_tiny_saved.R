...
load(file="wdcMerged_lin_weather_pr12_tiny.RData")
load(file="current_serv_lvl_lin_weather_pr12_tiny.RData")
load(file="user_serv_lvl_lin_weather_pr12_tiny.RData")
load(file="points_lin_weather_pr12_tiny.RData")
v0_vec <- c(0)
