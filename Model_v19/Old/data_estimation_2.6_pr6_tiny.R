...
for(tract in tract_list) {
  ...
  #   filelist_all <- c("Paris/ind_paris_7.csv")
  #   filelist_all_mons <- c(7)
  filelist_all_weather <- c("weatherdata_2013-7.csv")
...
###save commands
save(wdcMerged, file="wdcMerged_lin_weather_pr6_tiny.RData")
save(current_serv_lvl, file="current_serv_lvl_lin_weather_pr6_tiny.RData")
save(user_serv_lvl, file="user_serv_lvl_lin_weather_pr6_tiny.RData")
save(points, file="points_lin_weather_pr6_tiny.RData")
