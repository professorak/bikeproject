...
sink("r16.1_1:10_full_stepf_pr3.txt",split=T)
...
source("eval_covariates_delta_reg_stepset4_servlvl_densitycols_set4.R") #only density and catchement area instruments + service level ones
...
active_coef <- c(1,2,3,5)
active_coef_nointercept <- c(1,2,3)
...
ub = c(rep(300,2),1000000,0,1000000,rep(0,4),rep(10, length_delta), rep(1.0e19,length_eta))
