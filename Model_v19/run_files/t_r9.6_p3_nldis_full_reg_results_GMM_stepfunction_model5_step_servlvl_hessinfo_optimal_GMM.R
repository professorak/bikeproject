...
sink("r9.6_1:10_full_nldis_pr3.txt",split=T)
...
lb = c(-rep(100,2),0,rep(0,7),rep(-20, length_delta), rep(-1.0e19,length_eta))
ub = c(rep(100,2),1000000,rep(1000000,7),rep(10, length_delta), rep(1.0e19,length_eta))
