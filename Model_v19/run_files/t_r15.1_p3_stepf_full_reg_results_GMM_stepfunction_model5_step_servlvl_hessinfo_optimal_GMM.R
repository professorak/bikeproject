...
sink("r15.1_1:10_full_stepf_pr3.txt",split=T)
...
sourceCpp("eval_func_2_new_deltaaveraged_stepfunction_steps_set6.cpp") #distance step at 3rd quartile 0.165900 kms
...
lb = c(-rep(1000,2),0,rep(0,5),0,rep(-20, length_delta), rep(-1.0e19,length_eta))
ub = c(rep(1000,2),1000000,rep(1000000,5),0,rep(10, length_delta), rep(1.0e19,length_eta))
