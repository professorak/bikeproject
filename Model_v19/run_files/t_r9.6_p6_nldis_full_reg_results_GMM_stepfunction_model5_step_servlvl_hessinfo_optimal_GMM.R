...
sink("r9.6_1:10_full_nldis_pr6.txt",split=T)
...
density_google_places_theta_cols <- c(8,9,10)
...
theta <- c(-4 ,-4, 1, 146.83, 20, 203.69, 0.42, 0.42,0.42,9.41)
...
lb = c(-rep(1000,2),0,rep(0,7),rep(-20, length_delta), rep(-1.0e19,length_eta))
ub = c(rep(1000,2),1000000,rep(1000000,7),rep(10, length_delta), rep(1.0e19,length_eta))
