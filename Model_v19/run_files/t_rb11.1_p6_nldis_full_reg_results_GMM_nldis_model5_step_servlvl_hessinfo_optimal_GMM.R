...
sink("rb11.1_1:10_full_nldis_pr6.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb9.R") #all metro, googleplaces etc. density variables minus census density
#and catchement area instruments
