...
if(.Platform$OS.type=="windows"  & Sys.info()["user"]=="Ashish") {
  ...
  work_dir <- "C:/Users/Ashish/Dropbox/Ashish_Karan/Sustainable Transportation System/Data/Code/R/Model_v19"  
  dropbox_dir <- "C:/Users/Ashish/Dropbox/Ashish_Karan"
} else {
  if(.Platform$OS.type=="windows" & Sys.info()["user"]=="A") {
    #incidates my XPS DELL Machine
    work_dir <- "C:/Users/A/Dropbox/Ashish_Karan/Sustainable Transportation System/Data/Code/R/Model_v19"
  ...
  if((Sys.info()["user"])=="ashish") {
    ...
    work_dir <- "/home/ashish/Dropbox/Ashish_Karan/Sustainable Transportation System/Data/Code/R/Model_v19"
  ...
  if(.Platform$OS.type=="unix"  & (Sys.info()["user"])=="ashishkabra") {
    ...
    work_dir <- "/Users/ashishkabra/Dropbox/Ashish_Karan/Sustainable Transportation System/Data/Code/R/Model_v19"
  ...
  if(.Platform$OS.type=="unix"  & (Sys.info()["user"])=="ubuntu") {
    ...
    work_dir <- "/data/Dropbox/Ashish_Karan/Sustainable Transportation System/Data/Code/R/Model_v19"
