...
sink("deriv_test_moredensityvar.txt",append=T,split=T)
...
theta <- c(-4 ,-4,-4,-4, 1, 146.83, 20, 203.69, 0.42, 0.42,0.42,0.42,9.41)
...
lb = c(-rep(100,4),0,rep(0,8),rep(-20, length_delta), rep(-1.0e19,length_eta))
ub = c(rep(100,4),1000000,rep(1000000,8),rep(10, length_delta), rep(1.0e19,length_eta))
