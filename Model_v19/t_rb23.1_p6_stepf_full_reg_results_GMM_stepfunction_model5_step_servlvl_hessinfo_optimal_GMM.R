...
sink("rb23.1_1:10_full_stepf_pr6.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb23.R") #all googleplaces etc. density variables minus census density
...
theta <- c(-4 ,-4, 0, 0, 20, 0, rep(0.42, 5),0,1)
...
ub = c(rep(300,2),
       0,0,rep(1000000,1),0,rep(1000000,5),0,1000000,
