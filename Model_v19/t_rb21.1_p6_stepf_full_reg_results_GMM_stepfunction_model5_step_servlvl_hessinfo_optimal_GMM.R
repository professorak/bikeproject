...
sink("rb21.1_1:10_full_stepf_pr6.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb21.R") #all googleplaces etc. density variables minus census density
