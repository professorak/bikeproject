eval_covariates_delta_reg <- function(deltain,theta1,wdcMerged,points) {
  ...
  serv_step1 <- c(0,0.622900)
  serv_step2 <- c(0.622900,1.1)  
...
#                        )
  list_covariates <- c("catchment_area_step1","catchment_area_step2",
  ...
  Zserv_lvl <- cbind(trim_serv(wdcMerged$instr_serv_lvl[stocked_list],c(0,0.10800)),
    trim_serv_frac(wdcMerged$instr_serv_lvl[stocked_list],c(0.10800,0.5)),    
    trim_serv(wdcMerged$serv_lvl_neighbours[stocked_list],c(0,0.61100)),
    trim_serv(wdcMerged$serv_lvl_neighbours[stocked_list],c(0.61100,1.1))
    )
  colnames(Zserv_lvl) <- c("instr_serv_lvl1","instr_serv_lvl2",
          "serv_lvl_neighbours1","serv_lvl_neighbours2")
