...
###save commands
save(wdcMerged, file="wdcMerged_lin_weather_pr12.RData")
save(current_serv_lvl, file="current_serv_lvl_lin_weather_pr12.RData")
save(user_serv_lvl, file="user_serv_lvl_lin_weather_pr12.RData")
save(points, file="points_lin_weather_pr12.RData")

# save(wdcMerged, file="wdcMerged_lin_weather_pr6.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_weather_pr6.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_weather_pr6.RData")
# save(points, file="points_lin_weather_pr6.RData")
