...
load(file="wdcMerged_lin_weather_pr12.RData")
load(file="current_serv_lvl_lin_weather_pr12.RData")
load(file="user_serv_lvl_lin_weather_pr12.RData")
load(file="points_lin_weather_pr12.RData")
v0_vec <- c(0)
