lib_path <- Sys.getenv("DYLD_LIBRARY_PATH")
#lib_path <- paste0("/usr/local/lib:",lib_path)
lib_path <- paste0("/Users/ashishkabra/Programs/CoinIpopt/ThirdParty/HSL/build/lib:",lib_path)

Sys.setenv(DYLD_LIBRARY_PATH = lib_path)
#library.dynam("libhsl.dylib")
