...
theta <- c(-4 ,-4, 0, 146.83, 20, 0, 0.42, 0.42,0,1)
...
ub = c(rep(300,2),0,rep(1000000,2),0,rep(1000000,2),0,1000000,rep(10, length_delta), rep(1.0e19,length_eta))
