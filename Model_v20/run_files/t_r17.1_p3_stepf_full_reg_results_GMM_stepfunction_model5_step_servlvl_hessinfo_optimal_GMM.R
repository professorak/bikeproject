...
sink("r17.1_1:10_full_stepf_pr3.txt",split=T)
...
source("eval_covariates_delta_reg_stepset4_servlvl_densitycols_set5.R") #all metro, googleplaces etc. density variables and catchement area instruments + service level ones
