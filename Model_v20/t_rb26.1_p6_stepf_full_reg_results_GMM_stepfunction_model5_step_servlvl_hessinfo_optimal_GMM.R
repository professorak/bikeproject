...
sink("rb18.1_1:10_full_stepf_pr6.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb26.R") #all metro, googleplaces etc. density variables plus census density
