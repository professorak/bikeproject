...
###save commands
# save(wdcMerged, file="wdcMerged_lin_weather_aggmonths_averaged_pr6.RData")
# save(current_serv_lvl, file="current_serv_lvl_lin_weather_aggmonths_averaged_pr6.RData")
# save(user_serv_lvl, file="user_serv_lvl_lin_weather_aggmonths_averaged_pr6.RData")
# save(points, file="points_lin_weather_aggmonths_averaged_pr6.RData")
