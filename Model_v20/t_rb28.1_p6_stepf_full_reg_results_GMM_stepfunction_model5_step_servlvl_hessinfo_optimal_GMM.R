...
sink("rb20.1_1:10_full_stepf_pr6.txt",split=T)
...
source("eval_covariates_delta_reg_densitycols_setb28.R") #all metro, googleplaces etc. density variables plus census density
#and NO catchement area instruments + service level single step
#no _3,_4 moment conditions
...
theta <- c(-4 ,-4, 1, 146.83, 20, 0, rep(0.42, 5),0,1)
...
ub = c(rep(300,2),
       1000000,rep(1000000,2),0,rep(1000000,5),0,1000000,
